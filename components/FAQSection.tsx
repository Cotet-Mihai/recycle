...
export default function FAQSection() {
    return (
        <section className="py-24 px-6 lg:px-10 bg-transparent">
            ...
            <div className="max-w-4xl mx-auto relative bg-transparent p-8 lg:p-16 rounded-[3rem] overflow-hidden">
                <div className="absolute inset-0 opacity-5 pointer-events-none" />

                {/* Header */}
                <div className="text-center space-y-4 mb-16 relative z-10">
                    <span className="text-[#7bb831] uppercase tracking-[0.4em] font-black text-[10px]">
                        Suport & Info
                    </span>
                    <h2 className="font-serif text-4xl lg:text-5xl font-bold text-white leading-tight">
                        Întrebări <span className="italic text-[#d5b976]">Frecvente</span>
                    </h2>
                ...
                <Separator className="bg-white/5 mb-10 relative z-10" />
                        ...
                        >
                            <AccordionTrigger className="flex py-6 lg:py-8 hover:no-underline group text-left transition-all">
                                <div className="flex items-start gap-4 lg:gap-8 pr-4">
                                    ...
                                    <span className="font-sans text-[10px] font-black text-[#d5b976]/40 group-data-[state=open]:text-[#d5b976] transition-colors pt-2">
                                        {faq.index}
                                    </span>
                                    {/* Întrebarea */}
                                    <span className="font-serif text-lg lg:text-2xl font-bold text-gray-200 group-hover:text-[#d5b976] group-data-[state=open]:text-[#d5b976] transition-colors leading-tight">
                                        {faq.question}
                                    </span>
                                </div>
                            </AccordionTrigger>
                            ...
                            <AccordionContent className="pb-8 pl-10 lg:pl-[76px] pr-6">
                                <p className="text-gray-400 text-sm lg:text-lg leading-relaxed max-w-2xl border-l-2 border-[#7bb831]/30 pl-6 py-2">
                                    {faq.answer}
                                </p>
                            </AccordionContent>
                        </AccordionItem>
                ...
                <div className="mt-16 flex justify-center relative z-10">
                    <Link href="/contact">
                        <button className="group flex items-center gap-6 py-4 px-10 rounded-full border border-white/10 hover:border-[#d5b976]/50 bg-white/[0.02] transition-all duration-500">
                            ...
                            <div className="w-2 h-2 rounded-full bg-[#7bb831] shadow-[0_0_10px_#7bb831] group-hover:scale-150 transition-transform duration-500" />
                        </button>
                    </Link>
                </div>
            </div>
